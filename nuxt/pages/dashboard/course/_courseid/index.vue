        ...
        <div v-if="result?.course" class="container mx-auto my-6 flex gap-6">
          <div class="flex flex-col gap-2">
            ...
            <div
              ...
              class="relative h-12 overflow-hidden rounded border border-yellow-600 bg-yellow-400 p-2 text-xl text-yellow-50"
            >
              <div
  ...
  setup() {
    ...
    onResult((res) => {
      ...
      ctx.$mitt.emit('tabItems', [
        ...
        { name: '  نظرات من ' || '', icon: commentIcon },
        { name: '  درباره مدرس  ' || '', icon: studentIcon },
      ])
    })

    return { result, loading, userRateThisCourse }
  },
})
</script>
