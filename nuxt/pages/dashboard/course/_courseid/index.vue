    ...
    <div class="">
      <div>
        ...
        <h2 class="text-lg font-bold">
          {{ myCources.result.value?.course?.name }}
        </h2>
      </div>
      <div>
        this is course desc
        <h2 class="text-lg font-bold">
          {{ myCources.result.value?.course?.description }}
        </h2>
      </div>
    </div>
    ...
    <section class="text-gray-600 body-font">
      <div class="  py-4 mx-auto">
        <div class="flex flex-wrap ">
          <div
            v-for="ci in myCources.result.value?.course?.courseItem || []"
            :key="ci.id"
            class="p-4 md:w-1/3"
          >
            <div
...
export default defineComponent({
  ...
  setup () {
    ...
    const myCources = useQuery<CourseQuery, CourseQueryVariables>(MYCOURSE, {
